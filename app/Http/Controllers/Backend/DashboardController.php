...
class DashboardController
{
    ...
    { 
        ...
        $transporters = Transaction::join("carriers", "transactions.carrier", "carriers.id")->join('currencies', 'transactions.currency_id', 'currencies.id')->selectRaw("sum(transactions.amount) amount, carriers.transporter_name")
