    ...
    <x-slot name="body">
                ...
                <div class="col-3 mx-2 ">
                    <div class="input-group">
                        <div class="mb-3 col-sm-6">
                            ...
                            <select id="branch-code" multiple="multiple" name="branches[]" required>                                
                                <option value="SDNBO">SDNBO</option>
                                <option value="SDMBA">SDMBA</option>                               
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>{{ json_encode($approval_level->branches)}}</td>
                <td>
